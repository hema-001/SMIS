...
select distinct c.course_code, c.name,  c.teacher, c.credits, c.day, c.period, c.room from courses as c, teacher_select_course as cs, teacher as t where cs.course_code=c.course_code and cs.id=<%= session.getAttribute("id") %>;
</sql:query>
...
<td><a href="Controller?page=students-list&code=${ row.course_code}&id=${id}" style="background:royalblue; color:white; padding:5px"><c:out value="check students"></c:out></a></td>
</tr>
</table>
